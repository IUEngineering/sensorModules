...
% \newpage
    \input{appendix/pathloss/introduction}
    % \newpage
    \input{appendix/pathloss/methods}
    % \newpage
    \input{appendix/pathloss/results}
    % \newpage
    \input{appendix/pathloss/discussion}
    % \newpage
    \input{appendix/pathloss/conclusion}
