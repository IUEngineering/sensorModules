...
\begin{figure}[!htbp]
    \centering
    \def\svgwidth{0.75\textwidth}
    \includegraphics[width=\textwidth]{testUgsUds.png}
...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        ...
        \label{fig:resultpH4}
    \end{subfigure}
    \caption{De uitgang van de meetschakeling op pH 4 en pH 7. Beide metingen hebben dezelfde schaal. De x-assen zijn tijd, de y-assen zijn spanning.}
