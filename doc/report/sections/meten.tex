...
Aangezien er geen frequentieafhankelijkheden voorkomen kan de uitgangsspanningsruis uitgerekend worden. Dit wordt gedaan in \autoref{eq:measureNoiseVoltage}.
