...
% In ... is 
In de voorgaande paragrafen is in gegaan op hoe specificaties voor discriminatie in het frequentie domain de eigenschappen van een filter vaststellen. Hieronder staan deze specificaties:
\begin{itemize}
