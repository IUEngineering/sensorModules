...
De voorgaande modellen zijn niet compleet genoeg om de situatie in een bebouwd gebied te voorspellen. Om een beter model te krijgen kan er een fittings factor worden toegevoegd aan \cref{eq:FreeSpacePathLoss} \cite[24]{brini2019system}. \Cref{eq:fittingFactor} toont deze fittings factor waarin \(l_f\) een fittings coefficient is en $d$ de afstand tussen de twee antennes. \Cref{eq:calcPathLoss} toont de vergelijking van het uitgebreidere model van de path loss.
