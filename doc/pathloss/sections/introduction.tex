...
\end{equation}
In het geval dat er antennes worden gebruikt met isotrope eigenschappen volgt \autoref{eq:isotropicPathLoss} uit \autoref{eq:FreeSpacePathLoss}. Dit is omdat een antenne met isotrope eigenschappen een antenne versterking van $1$ heeft \cite{bensky2019shortRangeWirelessCommunication}.
