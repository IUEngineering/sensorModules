...
% bij IoT systemen erg wisselend wat het nodige bereik van het draadloze netwerk is. Om er voor te zorgen dat een draadloos systeem een minimaal bereik heeft moet er rekening gehouden worden met signaal verliezen. Een van deze verliezen is path loss. 
